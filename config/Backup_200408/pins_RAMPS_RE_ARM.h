...
#define Z_MAX_PIN          P1_28   //changed (19) 10k pullup to 3.3V, 1K series
//#define Z_MAX_PIN          -1
...
//#ifndef X_CS_PIN
  //#define X_CS_PIN         P1_01   //changed ETH
  #define X_CS_PIN         P0_26   // (63) E1_CS_PIN
//#endif
...
//#ifndef Y_CS_PIN
  //#define Y_CS_PIN         P1_04   //changed ETH
  #define Y_CS_PIN           P1_17   // (19) Z_MAX_PIN
//#endif
...
//#define TEMP_1_PIN          2   // P1_30
//#define TEMP_CHAMBER_PIN    2   // A2 (T2) - (69) - TEMP_1_PIN
...
//#define HEATER_1_PIN      P0_16                     //added for chamber temperature
//#define HEATER_CHAMBER_PIN     P0_16              //added for chamber temperature
 ...
 */
  ...
  #define LCD_PINS_D4      P2_06   // J3-8 & AUX-3 (SCK, CLK)
                               ...
                               //int   //LCD
  #define SCK_PIN        P0_15 //P0_07 //P0_15   // (52)  system defined J3-9 & AUX-3
  #define MISO_PIN       P0_17 //P0_08 //P0_17   // (50)  system defined J3-10 & AUX-3
  #define MOSI_PIN       P0_18 //P0_09 //P0_18   // (51)  system defined J3-10 & AUX-3
...
//  #endif
  ...
  //#define LCD_SDSS         P0_16   // (16) J3-7 & AUX-4
    ...
    #if ENABLED(FYSETC_MINI_12864)
                                 //int   //LCD
      #define DOGLCD_SCK   P0_15 //P0_07 //P0_15
      #define DOGLCD_MOSI  P0_18 //P0_09 //P0_18
    ...
    #define LCD_BACKLIGHT_PIN P2_11 //(16) J3-7 & AUX-4 - only used on DOGLCD controllers
    #define LCD_PINS_ENABLE -1 //P0_18  // (51) (MOSI) J3-10 & AUX-3
    #define LCD_PINS_D4    -1 //P0_15   // (52) (SCK)  J3-9 & AUX-3
    #if ENABLED(ULTIPANEL)
      #define LCD_PINS_D5  -1 //P1_17   // (71) ENET_MDIO
      #define LCD_PINS_D6  -1 //P1_14   // (73) ENET_RX_ER
      #define LCD_PINS_D7  -1 //P1_10   // (75) ENET_RXD1
    #endif
  #endif

  #if ENABLED(MINIPANEL)                //optins for mini panel
    // GLCD features
...
//
  ...
  #define ENET_MDIO        -1 //P1_17   // (71)  J12-4
  #define ENET_RX_ER       -1 //P1_14   // (73)  J12-6
  #define ENET_RXD1        -1 //P1_10   // (75)  J12-8
#endif
#define ENET_MOC           -1 //P1_16   // (70)  J12-3
#define REF_CLK            -1 //P1_15   // (72)  J12-5
#define ENET_RXD0          -1 //P1_09   // (74)  J12-7
#define ENET_CRS           -1 //P1_08   // (76)  J12-9
#define ENET_TX_EN         -1 //P1_04   // (77)  J12-10
#define ENET_TXD0          -1 //P1_00   // (78)  J12-11
#define ENET_TXD1          -1 //P1_01   // (79)  J12-12


//MY Pin definitions//////////////////////////////////////////

//#define BEEPER_PIN      P1_30   // (37) not 5V tolerant
//#define BTN_ENC         P2_11   // P0_28 (35) J3-3 & AUX-4
//#define BTN_ENC         P1_04
//#define BTN_EN1         P3_26   // (31) J3-2 & AUX-4
//#define BTN_EN2         P3_25   // (33) J3-4 & AUX-4
...
//Not needed for MINIPANEL
//#define LCD_PINS_RS      P0_16   //  (CS)
//#define LCD_PINS_ENABLE  P0_08   //  (SID, MOSI)
//#define LCD_PINS_D4      P0_07   //  (SCK, CLK)
//#define LCD_BACKLIGHT_PIN  P0_16   // backlight LED

//#define DOGLCD_CS        P0_26  //P1_18
//#define DOGLCD_A0        P2_06  //P1_19
//#define DOGLCD_CS        P1_09
//#define DOGLCD_A0        P1_14
...
//
  ...
  #define SCK_PIN          P0_07                          //Internel SD card
