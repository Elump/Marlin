 ...
 */
  ...
  #define BED_CHECK_INTERVAL 1000 //Changed  ms between checks in bang-bang control
...
#define AUTOTEMP
#if ENABLED(AUTOTEMP)
  #define AUTOTEMP_OLDWEIGHT 0.9             //changed to reduce tempreture dynamic
#endif
...
#define MAX_CONSECUTIVE_LOW_TEMPERATURE_ERROR_ALLOWED 5		//changed
...
#define MILLISECONDS_PREHEAT_TIME 10000						//changes
...
#if ENABLED(USE_CONTROLLER_FAN)                             //check later
 ...
 */
#define FAN_MIN_PWM 75                                      //changed to make fan running
 ...
 */
#define E0_AUTO_FAN_PIN -1                          //check later
 ...
 */
//#define CASE_LIGHT_ENABLE                         //check later
#if ENABLED(CASE_LIGHT_ENABLE)
  #define CASE_LIGHT_PIN 4                  //changed P1_18 on REARM Override the default pin if needed
...
#define X_HOME_BUMP_MM 0                  //just one Bump
#define Y_HOME_BUMP_MM 0                  //just one Bump
#define Z_HOME_BUMP_MM 1
#define HOMING_BUMP_DIVISOR { 2, 2, 2 }  // Re-Bump Speed Divisor (Divides the Homing Feedrate)
//#define QUICK_HOME                     //not working on Daycom // If homing includes X and Y, do a diagonal move initially
#define HOMING_BACKOFF_MM { 1, 1, 0.5 }  //changed to 1 (mm) Move away from the endstops after homing
...
#define DEFAULT_STEPPER_DEACTIVE_TIME 600 			//changed to 10min *60s =600
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {50*60, 50*60, 3*60, 60} // Feedrates for manual moves along X, Y, Z, E from panel
#endif
...
#define STATUS_MESSAGE_SCROLLING				          //changed

// On the Info Screen, display XY with one decimal place when possible
//#define LCD_DECIMAL_SMALL_XY

// The timeout (in ms) to return to the status screen from sub-menus
#define LCD_TIMEOUT_TO_STATUS 20000               //changed
 ...
 */
//#define LED_CONTROL_MENU						          //check later
   ...
   * point in the file.
   */
  //#define POWER_LOSS_RECOVERY										   //check later
 ...
 */
  ...
  //#define DOGM_SD_PERCENT                                   //check later
...
#define MIN_STEPS_PER_SEGMENT 5                     //changed
...
#define ADVANCED_PAUSE_FEATURE						//changed
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     8  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
   ...
   */
  #define TMC_USE_SW_SPI									                 //need update
  #define TMC_SW_MOSI       P0_18							             //need update
  #define TMC_SW_MISO       P0_17 						             //need update
  #define TMC_SW_SCK        P0_15							             //need update
